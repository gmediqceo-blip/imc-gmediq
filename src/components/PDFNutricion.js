...
<style>
  @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap');${baseCSS()}</style>
</head>
<body>

<button class="print-btn no-print" onclick="window.print()">Imprimir o Guardar PDF</button>
...
export function generarPDFGuiaFase({ fase, paciente, registroFase, usuario }) {
  ...
  const tiemposLabels = {
    ...
    almuerzo:     { emoji: '', nombre: 'Almuerzo' },
...
<div class="section">
  <div class="section-header">
    <div class="section-number">${sec()}</div>
    <div class="section-title">Menú Establecido</div>
  </div>
  <div class="section-content" style="padding: 0;">
    <table>
      <thead>
